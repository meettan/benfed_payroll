                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <label for="exampleInputName1">Joining Date:<span class="requiredfield">*</span></label>
                            <input type="date" class="form-control" name="join_dt" id="join_dt" required
                                    value=""
                            />
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class= "form-control" name = "phn_no" required
                        id   = "phn_no" value=""/>
                    </div>
                    <div class="col-6">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class= "form-control required" name = "basic_pay" required
                          id = "basic_pay" value=""/>
                    </div>
           ...
           <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text"
                        class= "form-control" name = "bank_ac_no" id="bank_ac_no" value="" />
                    </div>
                </div>
            </div> 
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class= "form-control" name = "pf_ac_no" id   = "pf_ac_no"
                        value="" />
                    </div>
                    <div class="col-6">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text"
                        class="form-control required" name="aadhar" id="aadhar"
                        value="" />
                    </div>
